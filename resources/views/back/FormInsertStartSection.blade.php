                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="form-validation">
                                    <form class="form-valide" action="/PostInsert" method="post" enctype="multipart/form-data">
                                    @csrf    
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="Term" placeholder="Enter a Term..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control"  name="Strong" placeholder="Enter a Strong..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-confirm-password" name="Paragraph" placeholder="Enter a Paragraph..">
                                            </div>
                                        </div>
