    ...
    ***********************************-->
    <!-- <div id="main-wrapper"> -->
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/backindex">start section homepage</a></li>
                            <li><a href="/WHATWECANOFFERSelectData">WHAT WE CAN OFFER</a></li>
                            <li><a href="/TRAINWITHEXPERTS">TRAIN WIT HEXPERTS</a></li>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="{{route('index')}}">GYM</a> 2018</p>
            </div>
        </div>
        <!--**********************************
            Footer end
